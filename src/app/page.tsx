    ...
    <section className="space-y-10 pb-10">
      <div className="skillhub-hero rounded-[2rem] p-8 md:p-10">
        ...
        <h1 className="mt-5 max-w-4xl text-3xl font-semibold leading-tight md:text-5xl">
          Курсы, практика, тесты и live-занятия в одном цифровом кампусе
        </h1>
        <p className="mt-4 max-w-2xl text-sm text-white/80 md:text-base">
          Платформа для системного обучения: строгая структура, контрастные
          панели и оранжевый акцент на ключевых действиях.
        </p>
